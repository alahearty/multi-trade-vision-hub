            ...
            await new[] {
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style='font-family:Arial,Helvetica,sans-serif;font-size:small'>
                                                        Thank you for creating an account on our MultiTradeHub.</p>
                                                    <p style='font-family:Arial,Helvetica,sans-serif;font-size:small'>
                                                    ...
                                                    <p>
                                                        ...
                                                        <a href='https://multi_trade_vision_api.com' target='_blank'>https://multi_trade_vision_api.com</a>
                                                    </p>
                ...
                new NotificationTemplate
                {
                    ...
                    EmailBody = """
                            ...
                            """,
                    SmsBody = "A new member [{MemberName}] has signed up on multi_trade_vision_api. Please review!"
                }
            }.SaveAsync();
        }
    }
